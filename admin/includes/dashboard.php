...
$payroll_made_query = "SELECT COUNT(*) as total_payrolls 
                       FROM payroll p 
...
$staff_by_dept_query = "SELECT staff_department, COUNT(*) as num_staff FROM staff WHERE staff_status = 1 GROUP BY staff_department";
$staff_by_dept_result = $conn->query($staff_by_dept_query);

// Recent 5 payroll records
$recent_payrolls_query = "SELECT payroll_ID, staff_ID, payroll_date FROM payroll ORDER BY payroll_ID DESC LIMIT 5";
