...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($result->num_rows > 0){
        echo "<script>alert('Error: IC already exists in the system. Redirecting ...'); history.back();</script>";
        exit();
    }    
