document.addEventListener("DOMContentLoaded", function (){
  ...
  const fields = [
    { id: 'ic',
      validate: validateIC,
      errorMessage: "Invalid IC. Please enter a 12-digit IC number." },
    { id: 'first_name',
      pattern: /^[A-Za-z\s]+$/,
    ...
    { id: 'phone_number',
      pattern: /^\d{10,15}$/,
      errorMessage: "Please enter a valid phone number with 10 to 15 digits." },
    { id: 'address',
      pattern: /.+/,
    ...
    { id: 'basic_salary',
      pattern: /^(\d+(\.\d{1,2})?)$/,
      errorMessage: "Please enter a valid salary greater than 0." },
    { id: 'position',
      pattern: /.+/,
